...
let contactPageObj = {
  openHours: "Monday - Friday: 8A-5P",
  closedHours: "Saturday - Sunday: CLOSED",
  address: "15500 Cherrywood Dr, Reno, NV 89511",
  email: "anakria977@gmail.com",
                        ...
                        "children": [
                          ...
                          },
                          {
                            ...
                            "options": {
                              ...
                              "original": {
                                "url": contactPageObj.primaryPhone,
                                "target": "",
                                "url_encoded": "true",
                                "font-size": "15",
                          ...
                          },
                          {
                            ...
                            "options": {
                              ...
                              "original": {
                                "url": `mailto:${contactPageObj.email}`,
                                "target": "",
                                "url_encoded": "true",
                                "font-size": "15",
                                "hover_color": "var(--secondary-hover-color)",
                              ...
                              "activeselector": false,
                              "ct_depth": false,
                              "ct_content": contactPageObj.email,
                              "hover": {
                                "color": "var(--secondary-hover-color)"
                              }
                            },
                          ...
                          },
                          {
                            ...
                            "options": {
                              ...
                              "activeselector": false,
                              "ct_depth": false,
                              "ct_content": contactPageObj.address,
                              "hover": {
                                "color": "var(--secondary-hover-color)"
                              }
                            },
                          ...
                          },
                          {
                            ...
                            "options": {
                              ...
                              "nicename": "Text (#127)",
                              "ct_content": contactPageObj.openHours,
                              "activeselector": false,
                              "classes": [
                                "font-semibold"
                              ]
                          ...
                          },
                          {
                            ...
                            "options": {
                              ...
                              "nicename": "Text (#137)",
                              "ct_content": contactPageObj.closedHours,
                              "activeselector": false,
                              "classes": [
                                "font-semibold"
                              ]
...
app.post('/api/chat/page/contact', async (req, res, next) => {
  contactPageObj.primaryPhone = req.body.primaryPhone;
  contactPageObj.email = req.body.email;
  contactPageObj.address = req.body.address;
  contactPageObj.openHours = req.body.openHours;
  contactPageObj.closedHours = req.body.closedHours;

  try {
    console.log(contactPageObj.contactPageJson);
    res.json(contactPageObj.contactPageJson); // send JSON string for content area
  }
  catch (err) {
    next(err); // Pass error to error handler
  }
